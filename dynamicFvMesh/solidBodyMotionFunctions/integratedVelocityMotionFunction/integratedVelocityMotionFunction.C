...
Description
    For constant-speed captive PMM manevuers. Mesh motion (displacement) is
    determined by integrating the velocity. Integration is performed with 
    trapezoidal rule using N=1000 subdivisions.
