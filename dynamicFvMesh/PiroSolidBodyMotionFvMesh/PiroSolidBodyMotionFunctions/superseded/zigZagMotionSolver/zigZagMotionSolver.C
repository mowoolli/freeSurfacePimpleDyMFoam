...
{
    defineTypeNameAndDebug(zigZagMotionSolver, 0);
    addToRunTimeSelectionTable(PiroSolidBodyMotionFunction, zigZagMotionSolver, dictionary);
};
};


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //
void Foam::solidBodyMotionFunctions::zigZagMotionSolver::makeFiles()
{
...
Foam::solidBodyMotionFunctions::zigZagMotionSolver::zigZagMotionSolver
(
...
Foam::septernion Foam::solidBodyMotionFunctions::zigZagMotionSolver::transformation()
{
...
//    alpha.z() *= rotationFree_.z();
    ...
    Info<< "solidBodyMotionFunctions::zigZagMotionSolver::transformation(): "
...
bool Foam::solidBodyMotionFunctions::zigZagMotionSolver::read(const dictionary& SBMFCoeffs)
{
