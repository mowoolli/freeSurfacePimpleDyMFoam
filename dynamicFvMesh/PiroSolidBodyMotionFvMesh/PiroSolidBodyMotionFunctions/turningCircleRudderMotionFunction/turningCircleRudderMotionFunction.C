...
#include "turningCircleRudderMotionFunction.H"
...
{
    defineTypeNameAndDebug(turningCircleRudderMotionFunction, 0);
    addToRunTimeSelectionTable
    (
        PiroSolidBodyMotionFunction,
        turningCircleRudderMotionFunction,
        dictionary
    );
}
}
...
void Foam::solidBodyMotionFunctions::turningCircleRudderMotionFunction::makeFiles()
{
...
Foam::solidBodyMotionFunctions::turningCircleRudderMotionFunction::turningCircleRudderMotionFunction
(
...
Foam::septernion
Foam::solidBodyMotionFunctions::turningCircleRudderMotionFunction::transformation()
{
...
//        quaternion R(eulerAngles/mag(eulerAngles + headingAngle), mag(eulerAngles));
    ...
    else if (deltaMax > (omega_->integrate(intStartTime,t)))
    {
        eulerAngles = omega_->integrate(intStartTime,t)*axis_;
...
//    quaternion R(eulerAngles/mag(eulerAngles), mag(eulerAngles));
    ...
    Info<< "solidBodyMotionFunctions::turningCircleRudderMotionFunction::transformation(): "
...
bool Foam::solidBodyMotionFunctions::turningCircleRudderMotionFunction::read
(
    const dictionary& SBMFCoeffs
)
{
