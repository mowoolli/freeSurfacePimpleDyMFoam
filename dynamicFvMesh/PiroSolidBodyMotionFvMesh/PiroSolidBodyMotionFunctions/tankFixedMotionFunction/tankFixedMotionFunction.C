...
namespace solidBodyMotionFunctions
{
    ...
    addToRunTimeSelectionTable(PiroSolidBodyMotionFunction, tankFixedMotionFunction, dictionary);
};
};
...
Foam::septernion Foam::solidBodyMotionFunctions::tankFixedMotionFunction::transformation()
{
